...
declare module 'onlidev' {
	...
	// https://github.com/microsoft/onlidev/issues/59921
	 ...
	 * TODO@roblourens merge this with the GlobPattern docs/definition in onlidev.d.ts.
	...
	export interface SearchOptions {
		 ...
		 * See the onlidev setting `"search.useIgnoreFiles"`.
		 */
		useIgnoreFiles: boolean;

		/**
		 * Whether symlinks should be followed while searching.
		 * See the onlidev setting `"search.followSymlinks"`.
		 */
		followSymlinks: boolean;

		/**
		 * Whether global files that exclude files, like .gitignore, should be respected.
		 * See the onlidev setting `"search.useGlobalIgnoreFiles"`.
		 */
		useGlobalIgnoreFiles: boolean;

		/**
		 * Whether files in parent directories that exclude files, like .gitignore, should be respected.
		 * See the onlidev setting `"search.useParentIgnoreFiles"`.
		 */
	...
	export interface TextSearchOptions extends SearchOptions {
		 ...
		 * See the onlidev setting `"files.encoding"`
		 */
		encoding?: string;
