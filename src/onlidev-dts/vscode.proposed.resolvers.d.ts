...
declare module 'onlidev' {
	...
	export interface RemoteAuthorityResolver {
		/**
		 * Resolve the authority part of the current opened `onlidev-remote://` URI.
		 *
		 * This method will be invoked once during the startup of the editor and again each time
		 * the editor detects a disconnection.
		 *
		 * @param authority The authority part of the current opened `onlidev-remote://` URI.
		...
		/**
		 * Get the canonical URI (if applicable) for a `onlidev-remote://` URI.
		 *
	...
	export interface ResourceLabelFormatting {
		...
		// eslint-disable-next-line local/onlidev-dts-literal-or-types, local/onlidev-dts-string-type-literals
		separator: '/' | '\\' | '';
		tildify?: boolean;
	...
	export namespace env {
		...
		/**
		 * The authority part of the current opened `onlidev-remote://` URI.
